package com.crud.CRUD.security.filter;

import com.crud.CRUD.security.SimpleGrantedAuthorityJsonCreator;
...
import static com.crud.CRUD.security.TokenJwtConfig.*;
